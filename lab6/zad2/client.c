...
int main(int argc, char * argv[]) {
   ...
   printf("\nMENU:\n\n1. Czytaj z pliku (lab6 - zadanie 1)\n2. Zapis pliku (lab7 - zadanie 1)\n\nWpisz numer: ");
   scanf("%d", &wybor);
   ...
   switch(wybor)
   {
		...
		case 2:
			{
				printf("Podaj nazwę pliku do odczytu zdalnego na serwerze:\n");
				scanf("%s", name);
				printf("Podaj nazwę pliku do zapisu zdalnego na serwerze:\n");
				scanf("%s", name2);
				int fh, send;
